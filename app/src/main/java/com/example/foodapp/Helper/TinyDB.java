...
public class TinyDB {
    ...
    public ArrayList<PopularModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PopularModel> playerList =  new ArrayList<PopularModel>();

        for(String jObjString : objStrings){
            PopularModel player  = gson.fromJson(jObjString,  PopularModel.class);
    ...
    public void putListObject(String key, ArrayList<PopularModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PopularModel player: playerList){
